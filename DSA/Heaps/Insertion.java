public class InsertionHeap {
    ...
    {
        //increase the size of the heap to add new element
        n++;

        //insert the element at the end of the heap
        arr[n-1] = value;

        //up-heapify will be done for elements
        heapify(arr, n, n-1);
    ...
    public static void main(String[] args) {
        ...
        //take current size of the array defined above
        int n = 5;

        int value = 80;  // value to be inserted
