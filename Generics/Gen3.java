...
public class Gen3 
{
    ...
    //     // List<Object> list4=new ArrayList<String>();  //Compile time error--both angle brackets must be same
    //     List<Integer> list5=new ArrayList<Integer>();

    //     //List<int> list6=new ArrayList<int>();  //compile time error--primitive data type can't be used
